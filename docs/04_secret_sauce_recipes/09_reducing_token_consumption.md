...
Cursor + Claudeは非常に強力なツールですが、**トークン消費=コスト**です。効率的な使い方を知ることで、コストを抑えながら生産性を最大化できます。

このレシピでは、実践的なトークン節約テクニックを学びます。
...
| モデル | 入力トークン | 出力トークン |
|--------|------------|------------|
| **Opus 4.5** | $15/1M tokens | $75/1M tokens |
...
**年間で考えると：**
- 毎日10回の対話 × 365日 = 年間3,650回
- **Opus 4.5:** 約$3,285/年
- **Sonnet 4.5:** 約$657/年

**効率的な使い方を知ることで、年間数千ドルのコスト削減が可能です。**
...
**戦略：**
- 全作業の80%をSonnet、20%をOpusにすることで、約75%のコスト削減が可能
...
3. 【Inline Edit + Sonnet】細かい調整（超低コスト）
   ↓
4. 【Chat + Opus】複雑な問題の相談（必要時のみ高コスト）
```
...
**これらのテクニックで、年間数千ドルのコスト削減が可能です。**

効率的なAI活用は、スキルの一部です。賢く使って、生産性とコスト効率の両方を最大化しましょう。
